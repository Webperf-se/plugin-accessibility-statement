...
export class HarAnalyzer {
        ...
        for (const entry of analyzedData.htmls) {
            ...
            if (body) {
                ...
                if (this.looks_like_a11y_statement(knowledgeData, body, doc)) {
                    ...
                    issues_if_a11y_statement.push(...this.tryGetEvaluationMethod(bodyText, knowledgeData));
                    issues_if_a11y_statement.push(...this.tryGetUpdatedDate(bodyText, knowledgeData));
    ...
    tryGetUpdatedDate(bodyText, knowledgeData) {
        ...
        if (uniqueDates.length === 0) {
            issues.push({
                ...
                category: 'a11y',
                text: `TEXT_REVIEW_NO_UPDATE_DATE`,
                severity: 'error',
            });
        }else {
            ...
            if (cutoff1Year < dateDoc) {
                ...
                issues.push({
                    ...
                    category: 'a11y',
                    text: `TEXT_REVIEW_OLDER_THAN_1YEAR_UPDATE_DATE`,
                    severity: 'error',
                });
            }
                ...
                issues.push({
                    ...
                    category: 'a11y',
                    text: `TEXT_REVIEW_OLDER_THAN_2YEAR_UPDATE_DATE`,
                    severity: 'error',
                });
            }
                ...
                issues.push({
                    ...
                    category: 'a11y',
                    text: `TEXT_REVIEW_OLDER_THAN_3YEAR_UPDATE_DATE`,
                    severity: 'error',
                });
            }
                ...
                issues.push({
                    ...
                    category: 'a11y',
                    text: `TEXT_REVIEW_OLDER_THAN_4YEAR_UPDATE_DATE`,
                    severity: 'error',
                });
            }
            else {
                issues.push({
                    ...
                    category: 'a11y',
                    text: `TEXT_REVIEW_OLDER_THAN_5YEAR_UPDATE_DATE`,
                    severity: 'error',
                });
    ...
    tryGetEvaluationMethod(bodyText, knowledgeData) {
        ...
        if (evaluationMethod) {
            ...
            issues.push({
                ...
                category: 'a11y',
                text: `TEXT_REVIEW_EVALUATION_METHOD_NOT_FOUND`,
                severity: 'error',
            });
        }
        return issues;
    ...
    tryGetNotificationUrl(url, body, doc, knowledgeData) {
            ...
            if (href && href.length > 0) {
                if (href === this.DIGG_URL) {
                    ...
                    issues.push({
                        ...
                        category: 'a11y',
                        text: `TEXT_REVIEW_NOTIFICATION_FUNCTION_CANONICAL_URL_FOUND`,
                        severity: 'info',
                            data: {
                    ...
                    if (digg_old_url) {
                        ...
                        issues.push({
                            ...
                            category: 'a11y',
                            text: `TEXT_REVIEW_NOTIFICATION_FUNCTION_OLD_URL_FOUND`,
                            severity: 'warning',
                            data: {
                                text: anchor.textContent.trim(),
                                url: href
        ...
        if (!knowledgeData['notification-function-link-url']) {
            issues.push({
                ...
                category: 'a11y',
                text: `TEXT_REVIEW_NOTIFICATION_FUNCTION_URL_NOT_FOUND`,
                severity: 'error',
            });
        }
        return issues;
        ...
        if (compatTextMatch) {
            ...
            if (knowledgeData['compatible-word'].indexOf('inte') !== -1) {
                issues.push({
                    ...
                    category: 'a11y',
                    text: `TEXT_REVIEW_COMPATIBLE_TEXT_A11Y_NOT_COMPATIBLE`,
                    severity: 'error',
                });
            }
                ...
                issues.push({
                    ...
                    category: 'a11y',
                    text: `TEXT_REVIEW_COMPATIBLE_TEXT_A11Y_PARTLY_COMPATIBLE`,
                    severity: 'error',
                });
            }
        }
            ...
            issues.push({
                ...
                category: 'a11y',
                text: `TEXT_REVIEW_COMPATIBLE_TEXT_OVERALL_NOT_FOUND`,
                severity: 'error',
            });
        }
        return issues;
    ...
    tryGetUnreasonablyBurdensomeAccommodation(url, bodyText, knowledgeData) {
        ...
        if (compatTextMatch) {
            ...
            issues.push({
                url: url,
                rule: 'has-nreasonably-burdensome',
                category: 'a11y',
                text: `TEXT_REVIEW_ADAPTATION_FOUND`,
                severity: 'error',
            });
        }
        return issues;
